...
if(!defined('COINSNAPBIF_VERSION' ) ) { define( 'COINSNAPBIF_VERSION', '1.1.0' );}
...
// Load shared vendor library (guards against double-loading via COINSNAP_CORE_VERSION constant).
require_once COINSNAPBIF_PLUGIN_DIR . 'vendor/coinsnap-core.php';
